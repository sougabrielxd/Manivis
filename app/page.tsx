...
export default function Home() {
  return (
    <>
      ...
      <nav>
        <div className="nav-logo">Manivis</div>
        <ul className="nav-links">
          <li>
            <a href="#hero">Início</a>
          </li>
          <li>
            <a href="#manipueira">Manipueira</a>
          </li>
          <li>
        ...
        <div className="hero-logo-wrap">
          <div className="logo-circle">
            <svg viewBox="0 0 120 80" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
              <ellipse cx="60" cy="18" rx="18" ry="8" fill="#2d8a1e" transform="rotate(-20 60 18)" />
              <ellipse cx="72" cy="12" rx="15" ry="6" fill="#3aac26" transform="rotate(10 72 12)" />
              <ellipse cx="48" cy="14" rx="14" ry="6" fill="#3aac26" transform="rotate(-35 48 14)" />
              <ellipse cx="60" cy="52" rx="32" ry="14" fill="#c87941" transform="rotate(-5 60 52)" />
              <ellipse cx="44" cy="58" rx="10" ry="5" fill="#b86d32" transform="rotate(15 44 58)" />
              <ellipse cx="74" cy="56" rx="8" ry="4" fill="#b86d32" transform="rotate(-10 74 56)" />
              <circle cx="40" cy="55" r="7" fill="#f5e6c8" />
              <circle cx="40" cy="55" r="4" fill="#ecdaba" />
            </svg>
            <span className="logo-circle-text">MANIVIS</span>
          </div>
        </div>
      </section>
